...
export function DashboardQuickActions() {
  ...
  return (
    <div className="flex flex-wrap gap-2">
      <Button to="/purchase-orders/new" variant="secondary" size="sm">
        <FileText className="h-4 w-4" />
        New PO
      </Button>
      <Button
        to={sellablePo
          ? `/sales-orders/new?poRef=${encodeURIComponent(sellablePo.ref)}`
          : '/sales-orders/new'}
        variant="secondary"
        size="sm"
      >
      ...
      <Button to="/lifts/new" variant="secondary" size="sm">
