...
const MARKETPLACE_GRID = 'grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5'

function AddOnTileSkeleton() {
  return (
    <div className="animate-pulse overflow-hidden rounded-2xl bg-white ring-1 ring-black/[0.05] dark:bg-card dark:ring-white/10">
      <div className="p-6">
